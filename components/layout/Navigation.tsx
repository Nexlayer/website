      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-14 sm:h-16">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            <Button
              className="bg-white !text-black hover:bg-transparent hover:border-cyan-400 hover:border-2 hover:!text-cyan-400 text-xs sm:text-sm px-3 sm:px-4 py-1.5 sm:py-2 font-medium rounded-lg transition-all duration-300"
