  ...
  const steps = [
    {
      ...
      description: "Generate a token and link Cursor, Claude Code, Windsurf or any AI coding agent — one line, and you're connected.",
    ...
    },
    {
      ...
      description: "Your app is now live and auto-scaling for free. Claim it, extend it or reserve to keep it running.",
    ...
    },
    {
      ...
      description: "Claim it to keep it live, share with friends, or reserve it to scale it globally in one click.",
    ...
    <section style={{ backgroundColor: "#191919" }} className="px-4 py-20">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          {/* Steps */}
          <div className="space-y-4 h-[600px] flex flex-col justify-between">
            {steps.map((step) => (
              <div
                key={step.id}
              ...
              >
                <div className="flex items-center mb-4">
                  <div className={`w-8 h-8 rounded-full flex items-center justify-center mr-3 ${
                    activeStep === step.id ? "bg-cyan-400 text-black" : "bg-gray-600 text-white"
                  }`}>
                    {step.id}
                  </div>
                  <h3 className={`text-lg font-bold ${activeStep === step.id ? "text-cyan-400" : "text-white"}`}>
                    {step.title}
                  </h3>
                </div>
          ...
          <div className="relative">
            <div className="bg-black border border-gray-700 rounded-2xl overflow-hidden w-[700px] h-[600px] group">
        ...
        <div className="text-center mt-12">
          ...
          <p className="text-gray-400 text-sm mt-3">
            Free to try in beta — deploy without signup. Claim it later if you want.
          </p>
        </div>
      </div>
    </section>
