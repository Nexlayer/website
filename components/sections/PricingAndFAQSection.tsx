  ...
  const pricingPlans = [
    {
      ...
      cta: "Start Free",
      ctaLink: "https://outgoing-violin-38-staging.authkit.app/sign-up?redirect_uri=https%3A%2F%2Fapp.nexlayer.io%2Fcallback&authorization_session_id=01K4JCGBPZSQKJ6J8XXGZ9QY4Z",
      popular: false
    },
    {
      name: "Scale Plan",
      subtitle: "For AI builders & startup founders launching products that scale",
      price: "$49",
      period: "/mo",
    ...
    },
    {
      ...
      description: "For enterprises running mission-critical workloads at global scale.",
      features: [
      ...
      cta: "Contact Sales",
      ctaLink: "https://cal.com/nexlayer/nexlayer-enterprise-custom-plan?overlayCalendar=true",
      popular: false,
      enterprise: true
    }
  ]
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-4">Plans & Billing</h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Nexlayer offers flexible plans to meet your needs. Choose the plan that works best for you and your business.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div 
                key={index} 
                className={`relative bg-black border border-gray-700 rounded-xl p-8 ${
              ...
              >
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="mb-6">
                    ...
                    {plan.period && <span className="text-gray-300 text-lg ml-1">{plan.period}</span>}
                  </div>
            ...
            <div className="flex items-center justify-between gap-6">
              <div className="flex-1">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Only 25 founders accepted in 2025 — just 13 spots left. Go from MVP → Cloud in 24h, free. 
                  Skip Kubernetes. Skip DevOps hires. Be live & investor-ready today. 
                  Includes 12 months Fractional CTO support + $300,000+ value free.
                </p>
              </div>
