      ...
      <section id="partners-section" className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-gray-300 text-center mb-12 max-w-3xl mx-auto">
            ...
            <span className="text-cyan-400">Let us help match you</span> with
            the perfect partner.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Partner 1 */}
            <Card className="flex flex-col justify-between bg-gray-900 border-gray-700 p-6 relative">
              <div>
                ...
                <div className="space-y-2 mb-6">
                  <p className="text-white">
                    <span className="text-gray-400">Budget:</span> Starting from
                    $1500
                  </p>
                  <p className="text-white">
                    <span className="text-gray-400">Hourly Rate:</span> $55/hr
                  </p>
                  <Link href="https://www.stellarstack.co/" target="_blank">
                  ...
                  <p className="text-cyan-400">
                    <span className="text-gray-400">Nexlayer Projects:</span>37
                  </p>
                </div>
                <div className="mb-6">
              ...
              <Button
                className="py-3 w-full bg-transparent border-2 border-cyan-400 text-cyan-400 hover:!bg-cyan-400 hover:!text-black font-medium transition-all duration-300"
                onClick={() =>
                  window.open(
                    "mailto:partnerships@nexlayer.com?subject=Hiring StellarStack for my Nexlayer project",
                    "_blank"
                  )
                }
              >
            ...
            <Card className="flex flex-col justify-between bg-gray-900 border-gray-700 p-6 relative">
              <div>
                ...
                <div className="space-y-2 mb-6">
                  ...
                  <p className="text-white">
                    <span className="text-gray-400">Hourly Rate:</span>$100/hr
                  </p>
                  <Link href="https://www.tekiesoft.com/" target="_blank">
                    <p className="text-cyan-400">
                      <span className="text-gray-400">Website:</span>
                      www.tekiesoft.com
                    </p>
                  ...
                  <p className="text-cyan-400">
                    <span className="text-gray-400">Nexlayer Projects:</span>23
                  </p>
                </div>
                <div className="mb-6">
                  <h4 className="text-white font-semibold mb-2">
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "mailto:partnerships@nexlayer.com?subject=Hiring Tekiesoft for my Nexlayer project",
                    "_blank"
                  )
                }
              >
            ...
            <Card className="flex flex-col justify-between bg-gray-900 border-gray-700 p-6 border-2 border-dashed border-cyan-400/50 hover:border-cyan-400 transition-all duration-300">
              <div>
                <div className="flex items-center mb-4">
                ...
                <div className="space-y-2 mb-6">
                  <p className="text-white">
                    <span className="text-gray-400">Benefits:</span> Preferred
                    partner status
                  </p>
                  <p className="text-white">
                    <span className="text-gray-400">Support:</span> Dedicated
                    partner resources
                  </p>
                  <p className="text-cyan-400">
                    <span className="text-gray-400">Growth:</span> Access to our
                    client network
                  </p>
                  <p className="text-cyan-400">
                    <span className="text-gray-400">Training:</span> Nexlayer
              ...
              <Button
                ...
                onClick={() =>
                  window.open(
                    "mailto:partnerships@nexlayer.com?subject=Looking to become a Nexlayer partner?",
                    "_blank"
                  )
                }
              >
